export const UI = {
  fr: {
    ...
    chooseFormatLabel: "Choisissez le format de téléchargement :",
    downloadCtaPdf: "Télécharger en PDF",
    downloadCtaWord: "Télécharger en Word",
  ...
  en: {
    ...
    chooseFormatLabel: "Choose your download format:",
    downloadCtaPdf: "Download as PDF",
    downloadCtaWord: "Download as Word",
